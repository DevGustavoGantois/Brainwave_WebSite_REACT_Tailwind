    ...
    <Section crosses className=''>
        <div className="container lg:flex">
            <div className="max-w-[25rem]">
                <h2 className='h2 mt-6 mb-2 md:mb-8'>Aplicativo Chat IA para colaboração perfeita</h2>
                <ul className="max-w-[22rem] mb-10 md:mb-14">
                    {collabContent.map((item) => (
                        <li className="mb-3 py-3" key={item.id}>
                            ...
                            {item.text && (
                                    <p className="body-2 mt-10 text-n-4">{item.text}</p>
                                )}
                        </li>
                    ))}
                </ul>
                        ...
                        <div className="flex w-60 aspect-square m-auto border border-n-6 rounded-full">
                            <div className="w-[6rem] aspect-square m-auto p-[0.2rem] bg-conic-gradient rounded-full">
                                <div className='flex items-center justify-center w-full h-full bg-n-8 rounded-full'>
                                    <img src={brainwaveSymbol} width={48} height={480} alt="brainwave" />
                                </div>
                            </div>
                        </div>
                        <ul className=''>
